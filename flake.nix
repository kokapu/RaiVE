  ...
  outputs = { self, ... }@inputs:
    ...
    in
    {
      ...
      packages = forAllSystems ({ pkgs, system }: rec {
        default = raive;
        raive = pkgs.buildRustWasiWasm {
          name = "raive";
          src = self;
        };
        raive-wasm-pkg = pkgs.buildWasmPackage { };
        raive-wasmtime-exec = pkgs.buildRustWasmtimeExec { };
        raive-wasmedge-exec = pkgs.buildRustWasmEdgeExec { };
      });
